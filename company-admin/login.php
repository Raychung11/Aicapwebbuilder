...
?><!doctype html>
<html><head><meta charset="utf-8"><title>Company Admin Login</title>
<style>body{font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;background:#1f2937;color:#fff;margin:0;height:100vh;display:flex;align-items:center;justify-content:center}
