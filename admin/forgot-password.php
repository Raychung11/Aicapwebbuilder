...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        pw_request_reset('super_admin', $email, '/admin/reset-password.php');
        $sent = true; // always show neutral success
    }
}
?><!doctype html>
<html lang="en">
...
button { width:100%; padding: 13px; border:0; cursor:pointer; background:#0f172a; color:#fff; font-weight:600; border-radius:10px; margin-top: 14px; font-size: 15px; }
...
<form class="card" method="post" autocomplete="on">
  ...
  <p class="lead">Enter the email tied to your AICAP HQ account and we'll send a reset link.</p>
