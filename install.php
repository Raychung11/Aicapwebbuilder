...
try {
    ...
    $columns_to_add = [
        ...
        ['products',  'is_promo',         "TINYINT(1) NOT NULL DEFAULT 0 AFTER is_featured"],
        ['products',  'promo_price',      "DECIMAL(12,2) DEFAULT NULL AFTER is_promo"],
        ['products',  'promo_starts_at',  "DATETIME DEFAULT NULL AFTER promo_price"],
        ['products',  'promo_ends_at',    "DATETIME DEFAULT NULL AFTER promo_starts_at"],
        ...
        ['branches',       'region',            "VARCHAR(60) DEFAULT NULL AFTER address"],
    ];
